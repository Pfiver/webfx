...
public final class CategoryAxis extends Axis<String> {
    ...
    private DoubleProperty startMargin = new SimpleDoubleProperty(5) {
...
//        }
    ...
    private DoubleProperty endMargin = new SimpleDoubleProperty(5) {
        @Override protected void invalidated() {
            requestAxisLayout();
        }
...
//        }
    ...
    /** This is the gap between one category and the next along this axis */
    private final DoubleProperty categorySpacing = new SimpleDoubleProperty(this, "categorySpacing", 1);
