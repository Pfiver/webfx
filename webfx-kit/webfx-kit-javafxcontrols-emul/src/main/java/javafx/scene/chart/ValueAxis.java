...
public abstract class ValueAxis<T extends Number> extends Axis<T> {
    ...
    private DoubleProperty scale = new SimpleDoubleProperty(this, "scale", 0) {
        @Override
    ...
    public final DoubleProperty scaleProperty() { return scale; }
    DoubleProperty scalePropertyImpl() { return scale; }
    ...
    private DoubleProperty minorTickLength = new SimpleDoubleProperty(5) {
        @Override protected void invalidated() {
            requestAxisLayout();
        }
...
//        }
     ...
     */
    private IntegerProperty minorTickCount = new SimpleIntegerProperty(5) {
        @Override protected void invalidated() {
            invalidateRange();
            requestAxisLayout();
        }
        ...
        private static final CssMetaData<ValueAxis<? extends Number>,Number> MINOR_TICK_COUNT =
         ...
         private static final CssMetaData<ValueAxis<? extends Number>,Boolean> MINOR_TICK_VISIBLE =
            new CssMetaData<ValueAxis<? extends Number>,Boolean>("-fx-minor-tick-visible",
                 new StyleConverter<>(), Boolean.TRUE) {
